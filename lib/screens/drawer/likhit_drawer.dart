                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    _buildDrawerItem(
                        ...
                        subItems: [
                          _buildDrawerSubItem('Direct Transactions', onTap: () {
                            Get.toNamed(ApplicationPages.clientSideTransaction);
                          }, icons: Icons.category),
                          _buildDrawerSubItem('Appointments Transactions',
                              onTap: () {
                            Get.toNamed(
                                ApplicationPages.clientAppointTransaction);
                          }, icons: Icons.category),
                          _buildDrawerSubItem('Payment Request', onTap: () {
                            Get.toNamed(ApplicationPages
      ...
      child: DrawerHeader(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Obx(() => controller.bottomNavController.userType.value ==
                      "Lawyer"
                  ? Column(
                      children: [
                        CircleAvatar(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          child: CircleAvatar(
                            backgroundColor: Colors.transparent,
                            radius: w50,
                            backgroundImage: NetworkImage(clientController
