class ClientPaymentRequestTransModel {
  String? message;
  int? respnseCode;
  int? count;
  int? currentPage;
  ...
  ClientPaymentRequestTransModel(
      {this.message,
        this.respnseCode,
        this.count,
        this.currentPage,
  ...
  ClientPaymentRequestTransModel.fromJson(Map<String, dynamic> json) {
...
class Lawyer {
  ...
  Lawyer.fromJson(Map<String, dynamic> json) {
    ...
    languageWritten = json['language_written'];
