...
class _LawyerEditProfileState extends State<LawyerEditProfile> {
  LawyerProfileControllerInside controller =
      Get.put(LawyerProfileControllerInside());
            ...
            : Column(
                ...
                children: [
                  ...
                  ConstTextField(
                    ...
                    maxLine: 3,
                    hintText:
                        "These steps sould help you resolve the issue. if te problem persisits.providing",
                  ),
