...
class ClientAppointmentInvoice extends StatefulWidget {
  final int paymentId;
  const ClientAppointmentInvoice({super.key, required this.paymentId, });
...
class _InvoicingState extends State<ClientAppointmentInvoice> {
  ...
  void initState() {
    ...
    controller.getAppointInvoiceData(widget.paymentId);
  }
        ...
        child: pw.Row(
          ...
          children:  [
            pw.Expanded(
              flex: 1,
              child: pw.Text(
                '${controller.invoiceDirectList.value.data?.lawyer?.servicesOffered}',
                maxLines: 1,
                softWrap: false,
            ...
            pw.Expanded(
              flex: 1,
              child: pw.Text(
                '${controller.invoiceDirectList.value.data?.status}',
                maxLines: 1,
                softWrap: false,
              ),
            ),
            pw.Expanded(
              flex: 1,
              child: pw.Text(
                '${controller.invoiceDirectList.value.data?.paymentAmount}',
                maxLines: 1,
                softWrap: false,
              ),
            ),
              ...
              children: [
                pw.Column(
                    ...
                    children: [
                      ...
                      constText('Lawyer Name: ${controller.invoiceDirectList.value.data?.lawyer?.name}', fontSize: 15),
                      constText('City : ${controller.invoiceDirectList.value.data?.lawyer?.city}'),
                      constText('State : ${controller.invoiceDirectList.value.data?.lawyer?.state}'),
                      constText('Country : ${controller.invoiceDirectList.value.data?.lawyer?.country}'),
                      constText('Mob No : ${controller.invoiceDirectList.value.data?.lawyer?.mobile}'),
                      constText('Area : ${controller.invoiceDirectList.value.data?.lawyer?.address}'),
                    ]
                ),
                pw.Column(
                    mainAxisAlignment: pw.MainAxisAlignment.start,
                    ...
                    children: [
                      ...
                      constText('${controller.invoiceDirectList.value.data?.paymentNo}', fontSize: 12),
                    ]
                ),
              ],
            ),
              ...
              children: [
                pw.Column(
                    ...
                    children: [
                      ...
                      constText('Customer :  ${controller.invoiceDirectList.value.data?.client?.name}', fontSize: 15),
                      constText('Area : ${controller.invoiceDirectList.value.data?.client?.address}'),
                      constText('City : ${controller.invoiceDirectList.value.data?.client?.city}'),
                      constText('Country : ${controller.invoiceDirectList.value.data?.client?.country}'),
                      constText('State : ${controller.invoiceDirectList.value.data?.client?.state}'),
                    ]
                ),
                pw.Column(
                    mainAxisAlignment: pw.MainAxisAlignment.start,
                    ...
                    children: [
                      ...
                      constText('${controller.invoiceDirectList.value.data?.createdDate}', fontSize: 9),
                      constText('Reference# : ', fontSize: 12),
                      constText('${controller.invoiceDirectList.value.data?.paymentNo}', fontSize: 9),
                    ]
                ),
              ],
            ),
                ...
                children: [
                  pw.Row(
                    ...
                    children: [
                      ...
                      pw.Text('${controller.invoiceDirectList.value.data?.paymentAmount.toString()}',
