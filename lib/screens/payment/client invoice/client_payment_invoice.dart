...
//                         ),
//                         Text(
//                           '${controller.invoicePaymentRequestDirectList.value.data?.paymentNo}',
...
//                       children: [
//                         Text(
//                           'Lawyer Name : ${controller.invoicePaymentRequestDirectList.value.data?[0].paymentId.toString()}',
//                           style: AppTextStyles.kSmall10RegularTextStyle,
//                         ),
//                         Text(
...
//                         ),
//                         Text(
//                           'Mob No : ${controller.invoicePaymentRequestDirectList.value.data}',
//                           style: AppTextStyles.kSmall10RegularTextStyle,
//                         ),
//                         Text(
...
//                         ),
//                         Text(
//                           '${controller.invoicePaymentRequestDirectList.value.data?.paymentNo.toString()}',
//                           style: AppTextStyles.kSmall10RegularTextStyle,
//                         )
//                       ],
//                     )
...
//                     ),
//                     Text(
//                       '${controller.invoicePaymentRequestDirectList.value.data?.paymentMethod.toString()}',
//                       style: AppTextStyles.kSmall10RegularTextStyle,
//                     ),
//                     Text(
