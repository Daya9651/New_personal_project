class LawyerProfileModel {
  String? message;
  int? responseCode;
  LawyerProfileModelData? data;

  LawyerProfileModel({this.message, this.responseCode, this.data});

  LawyerProfileModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    responseCode = json['response_code'];
    data = json['data'] != null ? LawyerProfileModelData.fromJson(json['data']) : null;
  }
...
class LawyerProfileModelData {
  ...
  LawyerProfileModelData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    email = json['email'];
