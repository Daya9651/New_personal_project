class LawyerAppointmentModel {
  ...
  LawyerAppointmentModel.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['appointment_received'] = appointmentReceived;
    data['appointment_accepted'] = appointmentAccepted;
    data['appointment_pending'] = appointmentPending;
    data['appointment_denied'] = appointmentDenied;
